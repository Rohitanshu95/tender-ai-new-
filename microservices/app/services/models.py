...
class Requirement(BaseModel):
    category: str = Field(..., description="Category (e.g., Financial, Technical, Legal)")
    requirement: str = Field(..., description="The specific requirement extracted")
    description: Optional[str] = Field(None, description="Detailed explanation or limit")
    mandatory: bool = True
