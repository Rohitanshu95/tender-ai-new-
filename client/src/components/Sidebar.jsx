  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute -right-3 top-10 w-6 h-6 bg-slate-900 text-white rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform z-30"
      >
      ...
      <div className="p-6 flex flex-col h-full overflow-hidden">
        ...
        <div className={`flex items-center space-x-3 mb-10 ${isCollapsed ? 'justify-center' : ''}`}>
          <div className="min-w-[40px] h-10 bg-slate-900 rounded-2xl flex items-center justify-center shadow-lg shadow-slate-200 shrink-0">
          ...
          {menuItems.map((item) => {
            ...
            return (
              <button
                ...
                className={`w-full flex items-center p-3 rounded-2xl text-sm font-bold transition-all group relative ${
                  isActive 
